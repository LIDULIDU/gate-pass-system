...
// dd($visit);
    ...
    // public function search(Request $request ,Visit $visits)
    // {
//         public function search( Request $visits )
// {
//     $category = $visits->category;

//     $visits = Visit::query();
//     if (!empty($visits->plates)) {
//         $visits->where('[plates]', 'LIKE', "%" . $visits->plates . "%");
//     }

//     if (!empty($visits->code)) {
//         $visits->where('code', 'LIKE', "%" . $visits->code . "%");
//     }

//     if (!empty($visits->email)) {
//         $visits->where('email', 'LIKE', "%" . $visits->email . "%");
//     }

//     $results =  $visits->get();

//     return view('visit.search', compact('category', 'results','visits'));
// // }
// //         $search_text = $_GET[ 'query'];
// //         $visits = Visit::where('visitor_list', 'LIKE', '%' .$search_text. '%')->where('code', 'LIKE', '%' .$search_text. '%')->where('plates', 'LIKE', '%' .$search_text. '%')->get();
// //          return view('visit.search' ,compact('visits','search_text'));
